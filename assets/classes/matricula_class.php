...
class Matricula{
    ...
    public function Inserir(){
        ...
        $comando->execute(array($this->id_matricula , $this->id_docente_fk, $this->id_curso_fk, $this->data_matricula, $this->status_matricula));
    ...
    public function Atualizar(){
        $banco = Banco::conectar();
        $sql = "UPDATE matricula SET id_matricula_fk = ?, id_docente_fk = ?, id_curso_fk = ?, data_matricula = ?, status_matricula = ? WHERE id_matricula = ?";
        $banco->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $comando = $banco->prepare($sql);
        $comando->execute(array($this->id_docente_fk, $this->id_curso_fk, $this->data_matricula, $this->status_matricula));
        Banco::desconectar();
