...
require_once('banco_class.php');
 ...
 //precisa por o nome igual ao banco de dados?
class Aluno{
    // Atributos:
    public $id;
    public $nome;
    ...
    public function Inserir(){
        ...
        // $sql = "INSERT INTO aluno (nome_aluno, rua_aluno, bairro_aluno, estado_aluno, cidade_aluno, pais_aluno, email_aluno, cep_aluno, tel_aluno) VALUES(?,?,?,?,?,?,?,?,?)";
        $sql = "CALL cad_aluno(?,?,?,?,?,?,?,?,?,?) ";
        // Conectando:
        ...
        $comando->execute(array($this->nome, $this->rua, $this->estado, $this->bairro, $this->cidade, $this->pais, $this->email, $this->cep, $this->tel1, $this->tel2));
